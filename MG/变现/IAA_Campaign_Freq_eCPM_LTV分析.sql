...
SELECT
    ...
    ROUND(CAST(SUM(total_rv_play) AS DOUBLE) / NULLIF(SUM(active_days), 0), 4)              AS "RV_Freq_per_DAU",
    ROUND(CAST(SUM(total_int_play) AS DOUBLE) / NULLIF(SUM(active_days), 0), 4)             AS "INT_Freq_per_DAU",
